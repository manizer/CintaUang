 ...
 */
(function(n){typeof define=="function"&&define.amd?define(["jquery"],n):typeof exports=="object"?module.exports=n:n(jQuery)})(function(n){function e(r){var f=r||window.event,w=h.call(arguments,1),l=0,o=0,e=0,a=0,b=0,k=0,v,y,p;if(r=n.event.fix(f),r.type="mousewheel","detail"in f&&(e=f.detail*-1),"wheelDelta"in f&&(e=f.wheelDelta),"wheelDeltaY"in f&&(e=f.wheelDeltaY),"wheelDeltaX"in f&&(o=f.wheelDeltaX*-1),"axis"in f&&f.axis===f.HORIZONTAL_AXIS&&(o=e*-1,e=0),l=e===0?o:e,"deltaY"in f&&(e=f.deltaY*-1,l=e),"deltaX"in f&&(o=f.deltaX,e===0&&(l=o*-1)),e!==0||o!==0)return f.deltaMode===1?(v=n.data(this,"mousewheel-line-height"),l*=v,e*=v,o*=v):f.deltaMode===2&&(y=n.data(this,"mousewheel-page-height"),l*=y,e*=y,o*=y),a=Math.max(Math.abs(e),Math.abs(o)),(!t||a<t)&&(t=a,s(f,a)&&(t/=40)),s(f,a)&&(l/=40,o/=40,e/=40),l=Math[l>=1?"floor":"ceil"](l/t),o=Math[o>=1?"floor":"ceil"](o/t),e=Math[e>=1?"floor":"ceil"](e/t),i.settings.normalizeOffset&&this.getBoundingClientRect&&(p=this.getBoundingClientRect(),b=r.clientX-p.left,k=r.clientY-p.top),r.deltaX=o,r.deltaY=e,r.deltaFactor=t,r.offsetX=b,r.offsetY=k,r.deltaMode=0,w.unshift(r,l,o,e),u&&clearTimeout(u),u=setTimeout(c,200),(n.event.dispatch||n.event.handle).apply(this,w)}function c(){t=null}function s(n,t){return i.settings.adjustOldDeltas&&n.type==="mousewheel"&&t%120==0}var o=["wheel","mousewheel","DOMMouseScroll","MozMousePixelScroll"],r="onwheel"in document||document.documentMode>=9?["wheel"]:["mousewheel","DomMouseScroll","MozMousePixelScroll"],h=Array.prototype.slice,u,t,f,i;if(n.event.fixHooks)for(f=o.length;f;)n.event.fixHooks[o[--f]]=n.event.mouseHooks;i=n.event.special.mousewheel={version:"3.1.12",setup:function(){if(this.addEventListener)for(var t=r.length;t;)this.addEventListener(r[--t],e,!1);else this.onmousewheel=e;n.data(this,"mousewheel-line-height",i.getLineHeight(this));n.data(this,"mousewheel-page-height",i.getPageHeight(this))},teardown:function(){if(this.removeEventListener)for(var t=r.length;t;)this.removeEventListener(r[--t],e,!1);else this.onmousewheel=null;n.removeData(this,"mousewheel-line-height");n.removeData(this,"mousewheel-page-height")},getLineHeight:function(t){var r=n(t),i=r["offsetParent"in n.fn?"offsetParent":"parent"]();return i.length||(i=n("body")),parseInt(i.css("fontSize"),10)||parseInt(r.css("fontSize"),10)||16},getPageHeight:function(t){return n(t).height()},settings:{adjustOldDeltas:!0,normalizeOffset:!0}};n.fn.extend({mousewheel:function(n){return n?this.bind("mousewheel",n):this.trigger("mousewheel")},unmousewheel:function(n){return this.unbind("mousewheel",n)}})});DataTable=function(n,t){var s,h,y,p,c,r,a,o,v,e,f,u,l,i;this.options={};this.table=n;this.currentPage=0;this.currentStart=0;this.filterIndex=[];for(r in DataTable.defaultOptions)DataTable.defaultOptions.hasOwnProperty(r)&&(this.options[r]=t.hasOwnProperty(r)?t[r]:DataTable.defaultOptions[r]);for(t.hasOwnProperty("data")&&(this.options.data=t.data),this.options.nbColumns<0&&(this.options.nbColumns=this.table.tHead.rows[0].cells.length),this.pagingDivs=document.querySelectorAll(this.options.pagingDivSelector),i=0;i<this.pagingDivs.length;++i)s=this.pagingDivs[i],this.addClass(s,"pagination-datatables"),this.addClass(s,this.options.pagingDivClass),h=document.createElement("ul"),this.addClass(h,this.options.pagingListClass),s.appendChild(h);if(this.pagingLists=document.querySelectorAll(this.options.pagingDivSelector+" ul"),this.counterDivs=document.querySelectorAll(this.options.counterDivSelector),this.loadingDiv=document.querySelector(this.options.loadingDivSelector),y=this,this.table.tHead||(this.table.tHead=document.createElement("thead"),this.table.appendChild(this.table.rows[0])),this.options.forceStrings&&(this.options.dataTypes=!1),p=this.table.tHead.rows[0].cells,this.table.tBodies[0]||(this.table.tBodies[0]=document.createElement("tbody")),this.options.data instanceof Array)this.data=this.options.data;else if(this.options.data instanceof Object){c=DataTable.defaultAjaxOptions;for(r in this.options.data)c[r]=this.options.data[r];if(this.options.data=c,a=!0,a)if(this.table.dataset.size!==undefined&&(this.options.data.size=parseInt(this.table.dataset.size,10)),this.data=[],this.options.data.size!==undefined)if(this.loadingDiv.innerHTML='<div class="progress datatable-load-bar"><div class="progress-bar progress-bar-striped active" style="width: 0%;"><\/div><\/div>',this.options.data.allInOne)this.getAjaxDataAsync(!0);else for(i=0;i<this.options.data.size;i+=this.options.pageSize*this.options.pagingNumberOfPages)this.getAjaxDataAsync(i);else this.loadingDiv.innerHTML='<div class="progress datatable-load-bar"><div class="progress-bar progress-bar-striped active" style="width: 0%;"><\/div><\/div>',this.getAjaxDataAsync(0,!0)}else if(this.table.tBodies[0].rows.length>0){for(this.data=[],o=this.table.tBodies[0].rows,v=o[0].cells.length,i=0;i<o.length;++i)this.data.push([]);for(e=0;e<v;++e){if(f=function(n){return n},this.options.dataTypes instanceof Array)switch(this.options.dataTypes[e]){case"int":f=parseInt;break;case"float":case"double":f=parseFloat;break;case"date":case"datetime":f=function(n){return new Date(n)};break;case!1:case!0:case"string":case"str":f=function(n){return n};break;default:f=this.options.dataTypes[e]}for(i=0;i<o.length;++i)this.data[i].push(f(o[i].cells[e].innerHTML.trim()))}if(this.options.dataTypes===!0)for(u=0;u<this.data[0].length;++u){for(l=!0,i=0;i<this.data.length;++i)this.data[i][u]===""||this.data[i][u]-parseFloat(this.data[i][u])+1>=0||(l=!1);if(l)for(i=0;i<this.data.length;++i)this.data[i][u]!==""&&(this.data[i][u]=parseFloat(this.data[i][u]))}}this.createSort();this.createFilter();this.triggerSort();this.filter()};DataTable.prototype={constructor:DataTable,addClass:function(n,t){typeof t=="string"&&(t=t.split(" "));t.forEach(function(t){t&&n.classList.add(t)})},removeNode:function(n){n&&n.parentNode.removeChild(n)},setRefreshTimeout:function(){this.options.data.refresh&&(clearTimeout(this.refreshTimeOut),this.refreshTimeOut=setTimeout(function(n){return function(){n.getAjaxDataAsync(0,!0)}}(this),this.options.data.refresh))},hideLoadingDivs:function(){this.removeNode(this.loadingDiv)},updateLoadingDivs:function(){this.data.length>=this.options.data.size?(this.setRefreshTimeout(),this.hideLoadingDivs()):this.loadingDiv.querySelector("div.progress .progress-bar").style.width=parseInt(100*this.data.length/this.options.data.size,10)+"%"},getAjaxDataAsync:function(n,t){var i;typeof t=="undefined"&&(t=!1);t&&typeof this.syncData=="undefined"&&(this.syncData={data:[],toAdd:[],toUpdate:{},toDelete:[]});i=new XMLHttpRequest;i.timeout=this.options.data.timeout;i.onreadystatechange=function(n,t,r){return function(){var u,f;if(this.readyState==4)switch(this.status){case 200:if(r)if(this.response.length>0)n.syncData.data=n.syncData.data.concat(this.response),n.getAjaxDataAsync(t+n.options.pageSize*n.options.pagingNumberOfPages,!0);else{u=n.syncData;delete n.syncData;n.data=u.data;n.addRows(u.toAdd);u.toDelete.forEach(function(t){t instanceof Function?n.deleteAll(t):n.deleteRow(t)});for(f in u.toUpdate)n.updateRow(f,u.toUpdate[f]);n.sort(!0);n.setRefreshTimeout()}else n.data=n.data.concat(this.response),n.updateLoadingDivs(),n.sort(!0);break;case 404:case 500:console.log("ERROR: "+this.status+" - "+this.statusText);console.log(i);break;default:n.getAjaxDataAsync(t,r)}}}(this,n,t);var u=this.options.data.url,f=this.options.pageSize*this.options.pagingNumberOfPages,r=new FormData;n!==!0&&(this.options.data.type.toUpperCase()=="GET"?u+="?start="+n+"&limit="+f:(r.append("offset",n),r.append("limit",f)));i.open(this.options.data.type,u,!0);i.responseType="json";i.send(r)},getLastPageNumber:function(){return parseInt(Math.ceil(this.filterIndex.length/this.options.pageSize),10)},updatePaging:function(){var e=this.options.pagingNumberOfPages,t=this,i=parseInt(this.currentStart/this.options.pageSize,10)+1,u=this.getLastPageNumber(),f,c,l=this.filterIndex.length?this.currentStart+1:0,a=this.currentStart+this.options.pageSize>this.filterIndex.length?this.filterIndex.length:this.currentStart+this.options.pageSize,s,r,h,o,n;for(i<e/2?f=1:i>=u-e/2?(f=u-e+1,f<1&&(f=1)):f=parseInt(i-e/2+1,10),c=f+e<u+1?f+e-1:u,s=0;s<this.pagingLists.length;++s){if(r=[],t.options.firstPage&&(n=document.createElement("li"),i===1&&n.classList.add("active"),n.innerHTML='<a data-page="first">'+t.options.firstPage+"<\/a>",r.push(n)),t.options.prevPage&&(n=document.createElement("li"),i===1&&n.classList.add("active"),n.innerHTML='<a data-page="prev">'+t.options.prevPage+"<\/a>",r.push(n)),t.options.pagingPages)h=this.options.pagingPages.call(this.table,f,c,i,l,a),h instanceof Array?r=r.concat(h):r.push(h);else for(o=f;o<=c;o++)n=document.createElement("li"),o===i&&n.classList.add("active"),n.innerHTML='<a data-page="'+o+'">'+o+"<\/a>",r.push(n);t.options.nextPage&&(n=document.createElement("li"),(i===u||u===0)&&n.classList.add("active"),n.innerHTML='<a data-page="next">'+t.options.nextPage+"<\/a>",r.push(n));t.options.lastPage&&(n=document.createElement("li"),(i===u||u===0)&&n.classList.add("active"),n.innerHTML='<a data-page="last">'+t.options.lastPage+"<\/a>",r.push(n));this.pagingLists[s].innerHTML="";r.forEach(function(n){n.childNodes.length>0&&n.childNodes[0].addEventListener("click",function(){if(!this.parentNode.classList.contains("active")&&typeof this.dataset.page!="undefined")switch(this.dataset.page){case"first":t.loadPage(1);break;case"prev":t.loadPage(i-1);break;case"next":t.loadPage(i+1);break;case"last":t.loadPage(u);break;default:t.loadPage(parseInt(parseInt(this.dataset.page),10))}},!1);this.pagingLists[s].appendChild(n)},this)}},updateCounter:function(){for(var t=this.filterIndex.length?parseInt(this.currentStart/this.options.pageSize,10)+1:0,i=parseInt(Math.ceil(this.filterIndex.length/this.options.pageSize),10),r=this.filterIndex.length?this.currentStart+1:0,u=this.currentStart+this.options.pageSize>this.filterIndex.length?this.filterIndex.length:this.currentStart+this.options.pageSize,n=0;n<this.counterDivs.length;++n)this.counterDivs[n].innerHTML=this.options.counterText.call(this.table,t,i,r,u,this.filterIndex.length,this.data.length)},getSortFunction:function(){if(this.options.sort===!1)return!1;if(this.options.sort instanceof Function)return this.options.sort;if(this.data.length===0||!(this.options.sortKey in this.data[0]))return!1;var n=this.options.sortKey,t=this.options.sortDir==="asc";return this.options.sort[n]instanceof Function?function(i){return function(r,u){var f=r[n],e=u[n];return t?i(f,e):-i(f,e)}}(this.options.sort[n]):function(i,r){var u=i[n],f=r[n];return u>f?t?1:-1:u<f?t?-1:1:0}},destroyFilter:function(){this.removeNode(this.table.querySelector(".datatable-filter-line"))},changePlaceHolder:function(){for(var i=this.options.filterText?this.options.filterText:"",t=this.table.querySelectorAll('.datatable-filter-line input[type="text"]'),n=0;n<t.length;++n)t[n].placeholder=i},createTextFilter:function(n){var i=this.options.filters[n],t=i instanceof HTMLInputElement?i:document.createElement("input"),r,u;return t.type="text",this.options.filterText&&(t.placeholder=this.options.filterText),this.addClass(t,"datatable-filter datatable-input-text"),t.dataset.filter=n,this.filterVals[n]="",r=function(){var n=0;return function(t,i){clearTimeout(n);n=setTimeout(t,i)}}(),t.onkeyup=function(n){return function(){var t=this.value.toUpperCase(),i=this.dataset.filter;r(function(){n.filterVals[i]=t;n.filter()},300)}}(this),t.onkeydown=t.onkeyup,u=i==="regexp"||t.dataset.regexp,i instanceof Function?this.addFilter(n,i):u?this.addFilter(n,function(n,t){return new RegExp(t).test(String(n))}):this.addFilter(n,function(n,t){return String(n).toUpperCase().indexOf(t)!==-1}),this.addClass(t,this.options.filterInputClass),t},_isIn:function(n,t){for(var i=!1,r=0;r<t.length&&!i;++r)i=t[r]==n;return i},_index:function(n,t){var r,i;if(t===undefined||t===null)return-1;for(r=-1,i=0;i<t.length&&r==-1;++i)t[i]===n&&(r=i);return r},_keys:function(n){var t,i;if(n===undefined||n===null)return undefined;t=[];for(i in n)n.hasOwnProperty(i)&&t.push(i);return t},createSelectFilter:function(n){var t=this.options.filters[n],u={},f=[],o=!1,a=!0,w=this.options.filterEmptySelect,v=!1,y,i,s,e,p,h,r,c,l;if(t instanceof HTMLSelectElement?v=t:t instanceof Object&&"element"in t&&t.element&&(v=t.element),t instanceof HTMLSelectElement||t==="select")u=this.getFilterOptions(n);else if(o="multiple"in t&&t.multiple===!0,a="empty"in t&&t.empty,w="empty"in t&&typeof t.empty=="string"?t.empty:this.options.filterEmptySelect,"values"in t){if(u=t.values==="auto"?this.getFilterOptions(n):t.values,"default"in t)f=t["default"];else if(o){f=[];for(y in u)u[y]instanceof Object?f=f.concat(this._keys(u[y])):f.push(y)}else f=[];f instanceof Array||(f=[f])}else u=t,f=o?this._keys(u):[];i=v?v:document.createElement("select");o&&(i.multiple=!0);t["default"]&&(i.dataset["default"]=t["default"]);this.addClass(i,"datatable-filter datatable-select");i.dataset.filter=n;a&&(r=document.createElement("option"),r.dataset.empty=!0,r.value="",r.innerHTML=w,i.appendChild(r));s=[];for(e in u)if(u[e]instanceof Object){p=document.createElement("optgroup");p.label=e;for(h in u[e])u[e].hasOwnProperty(h)&&(s.push(h),r=document.createElement("option"),r.value=h,r.selected=this._isIn(h,f),r.innerHTML=u[e][h],p.appendChild(r));i.appendChild(p)}else s.push(e),r=document.createElement("option"),r.value=e,r.selected=this._isIn(e,f),r.innerHTML=u[e],i.appendChild(r);if(c=i.value,o)for(c=[],l=0;l<i.options.length;++l)i.options[l].selected&&c.push(i.options[l].value);return this.filterVals[n]=o?c:a&&!c?s:[c],i.onchange=function(n,t,i,r){return function(){var u=this.value,f,e;if(t)for(u=[],f=0;f<this.options.length;++f)this.options[f].selected&&u.push(this.options[f].value);e=this.dataset.filter;r.filterVals[e]=t?u:i&&!u?n:[u];r.filter()}}(s,o,a,this),t instanceof Object&&t.fn instanceof Function?(this.addFilter(n,t.fn),i.dataset.filterType="function"):(this.addFilter(n,function(n,t){return function(i,r){return r?r==n&&!i?!0:t._isIn(i,r):!1}}(s,this)),i.dataset.filterType="default"),this.addClass(i,this.options.filterSelectClass),i},createFilter:function(){var f,e,t,n,r;if(this.filters=[],this.filterTags=[],this.filterVals=[],this.options.filters==="*")for(f=this.table.tHead.rows[0].cells.length,this.options.filters=[];f--;)this.options.filters.push(!0);if(this.options.filters){e=!1;t=document.createElement("tr");t.classList.add("datatable-filter-line");for(n in this.options.filters)if(this.options.filters.hasOwnProperty(n)){if(r=document.createElement("td"),this.options.filters[n]!==!1){var i=this.options.filters[n],o=i===!0||i==="regexp"||i==="input"||i instanceof Function||i instanceof HTMLInputElement,u=o?this.createTextFilter(n):this.createSelectFilter(n);this.filterTags[n]=u;document.body.contains(u)||(r.classList.add("datatable-filter-cell"),r.appendChild(u))}this.options.filters[n]instanceof Object&&this.options.filters[n].noColumn||t.appendChild(r)}t.querySelectorAll("td.datatable-filter-cell").length>0&&this.table.tHead.appendChild(t)}},filter:function(n){var o,s,u,e,i,r,h,f,t;for(typeof n=="undefined"&&(n=!1),o=this.currentStart,this.currentStart=0,this.filterIndex=[],t=0;t<this.data.length;t++)this.checkFilter(this.data[t])&&this.filterIndex.push(t);if(n){for(this.currentStart=o;this.currentStart>=this.filterIndex.length;)this.currentStart-=this.options.pageSize;this.currentStart<0&&(this.currentStart=0)}if(this.options.filterSelectOptions&&this.filterIndex.length>0){for(s=this,u=[],i=0;i<this.data[0].length;++i)u.push({});for(t=0;t<this.filterIndex.length;++t)for(e=this.data[this.filterIndex[t]],i=0;i<e.length;++i)u[i][e[i]]=!0;for(r=0;r<u.length;++r)if(h=this._keys(u[r]),this.filterTags[r]&&this.filterTags[r]instanceof HTMLSelectElement&&this.filterTags[r].dataset.filterType=="default")for(f=this.filterTags[r].childNodes,t=0;t<f.length;++t)f[t].dataset.empty||(f[t].style.display=s._isIn(f[t].value,h)?"block":"none")}this.refresh()},resetFilters:function(){var n=this;this.filterTags.forEach(function(t){var u=t.dataset.filter,r,i;if(t instanceof HTMLInputElement)t.value="",n.filterVals[u]="";else if(t.multiple){for(r=[],i=0;i<t.childNodes.length;++i)t.childNodes[i].selected=!0,r.push(t.childNodes[i].value);n.filterVals[u]=r}else if(t.dataset["default"]&&t.querySelector('option[value="'+t.dataset["default"]+'"]').length>0){for(i=0;i<t.childNodes.length;++i)t.childNodes[i].selected=t.childNodes[i].value==t.dataset["default"];n.filterVals[u]=[t.dataset["default"]]}else if(t.childNodes.length>0){for(t.childNodes[0].selected=!0,i=1;i<t.childNodes.length;++i)t.childNodes[i].selected=!1;if(t.childNodes[0].dataset.empty){for(r=[],i=1;i<t.childNodes.length;++i)r.push(t.childNodes[i].value);n.filterVals[u]=r}else n.filterVals[u]=[t.childNodes[0].value]}});this.filter()},stripTags:function(n){var t=document.createElement("div");return t.innerHTML=n,t.textContent||t.innerText},checkFilter:function(n){var r=!0,t,i;for(t in this.filters)if(i=t[0]==="_"?n:n[t],typeof i=="string"&&(i=this.stripTags(i)),!this.filters[t](i,this.filterVals[t])){r=!1;break}return r},addFilter:function(n,t){this.filters[n]=t},getFilterOptions:function(n){var f={},t=[],i,r,u;for(i in this.data)this.data[i][n]!==""&&t.push(this.data[i][n]);t.sort();for(r in t)t.hasOwnProperty(r)&&(u=this.stripTags(t[r]),f[u]=u);return f},destroySort:function(){$("thead th").removeClass("sorting sorting-asc sorting-desc").unbind("click.datatable").removeData("sort")},createSort:function(){var n=this,r,i,t,u;if(!(this.options.sort instanceof Function))for(r=0,i=this.table.tHead.rows[0].cells,t=0;t<i.length;++t)i[t].dataset.sort?n.options.sort=!0:n.options.sort==="*"?i[t].dataset.sort=r:(n.options.sort instanceof Array?u=r:n.options.sort instanceof Object&&(u=n._keys(n.options.sort)[r]),u!==undefined&&n.options.sort[u]&&(i[t].dataset.sort=u)),i[t].dataset.sort!==undefined&&i[t].classList.add("sorting"),r++,i[t].addEventListener("click",function(){var i,t;if(this.dataset.sort){if(this.classList.contains("sorting-asc"))n.options.sortDir="desc",this.classList.remove("sorting-asc"),this.classList.add("sorting-desc");else if(this.classList.contains("sorting-desc"))n.options.sortDir="asc",this.classList.remove("sorting-desc"),this.classList.add("sorting-asc");else{for(i=this.parentNode.cells,t=0;t<i.length;t++)i[t].classList.remove("sorting-desc"),i[t].classList.remove("sorting-asc");n.options.sortDir="asc";n.options.sortKey=this.dataset.sort;this.classList.add("sorting-asc")}n.sort();n.refresh()}},!1)},triggerSort:function(){var t,i,n;if(this.options.sort instanceof Function)this.sort(),this.refresh();else if(this.options.sortKey!==!1){for(t=this.table.tHead.rows[0].cells,n=0;n<t.length;n++)t[n].classList.remove("sorting-desc"),t[n].classList.remove("sorting-asc"),t[n].dataset.sort===this.options.sortKey&&(i=t[n]);i!==undefined&&(i.classList.add("sorting-"+this.options.sortDir),this.sort(),this.refresh())}},sort:function(n){var t=this.getSortFunction();t!==!1&&this.data.sort(t);this.filter(n)},identify:function(n,t){return this.options.identify===!1?!1:this.options.identify instanceof Function?this.options.identify(n,t):t[this.options.identify]==n},indexOf:function(n){for(var i=-1,t=0;t<this.data.length&&i===-1;t++)this.identify(n,this.data[t])&&(i=t);return i},row:function(n){return this.options.identify===!0?this.data[n]:this.data[this.indexOf(n)]},all:function(n){var i,t;if(typeof n=="undefined"||n===!0)return this.data;for(i=[],t=0;t<this.data.length;++t)n(this.data[t])&&i.push(this.data[t]);return i},addRow:function(n){this.data.push(n);typeof this.syncData!="undefined"&&this.syncData.toAdd.push(n);this.sort();this.filter();this.currentStart=parseInt(this._index(this._index(n,this.data),this.filterIndex)/this.options.pageSize,10)*this.options.pageSize;this.refresh()},addRows:function(n){this.data=this.data.concat(n);typeof this.syncData!="undefined"&&(this.syncData.toAdd=this.syncData.toAdd.concat(n));this.sort();this.filter();this.currentStart=parseInt(this._index(this._index(n,this.data),this.filterIndex)/this.options.pageSize,10)*this.options.pageSize;this.refresh()},deleteRow:function(n){var t=this.currentStart,i=this.indexOf(n);if(i===-1){console.log("No data found with id: "+n);return}this.data.splice(i,1);typeof this.syncData!="undefined"&&this.syncData.toDelete.push(n);this.filter();t<this.filterIndex.length?this.currentStart=t:(this.currentStart=t-this.options.pageSize,this.currentStart<0&&(this.currentStart=0));this.refresh()},deleteAll:function(n){var i=this.currentStart,r=[],t;for(typeof this.syncData!="undefined"&&this.syncData.toDelete.push(n),t=0;t<this.data.length;++t)n(this.data[t])||r.push(this.data[t]);this.data=r;this.filter();i<this.filterIndex.length?this.currentStart=i:(this.currentStart=i-this.options.pageSize,this.currentStart<0&&(this.currentStart=0));this.refresh()},updateRow:function(n,t){var r=this.indexOf(n),i;if(typeof this.syncData!="undefined"&&(this.syncData.toUpdate[n]=t),r!==-1){n in t&&delete t[n];for(i in this.data[r])i in t&&(this.data[r][i]=t[i]);this.sort();this.filter();this.currentStart=parseInt(this._index(this.indexOf(n),this.filterIndex)/this.options.pageSize,10)*this.options.pageSize;this.refresh()}},loadPage:function(n){var t=this.currentStart/this.options.pageSize;n<1?n=1:n>this.getLastPageNumber()&&(n=this.getLastPageNumber());this.currentStart=(n-1)*this.options.pageSize;this.refresh();this.options.onChange.call(this.table,t+1,n)},getCurrentPage:function(){return this.currentStart/this.options.pageSize+1},refresh:function(){var n,t,i;if(this.options.beforeRefresh.call(this.table),this.updatePaging(),this.updateCounter(),this.table.tBodies[0].innerHTML="",this.currentStart>=this.currentDataLength){this.table.tBodies[0].innerHTML='<tr><td colspan="'+this.options.nbColumns+'"><div class="progress progress-striped active"><div class="bar" style="width: 100%;"><\/div><\/div><\/div><\/tr>';return}for(n=0;n<this.options.pageSize&&n+this.currentStart<this.filterIndex.length;n++)t=this.filterIndex[this.currentStart+n],i=this.data[t],this.table.tBodies[0].appendChild(this.options.lineFormat.call(this.table,t,i));this.options.afterRefresh.call(this.table)},setOption:function(n,t){n in this.options&&(this.options[n]=t,n==="sort"&&(this.destroySort(),this.createSort(),this.triggerSort()),(n==="sortKey"||n==="sortDir")&&this.sort(),n==="filters"&&(this.destroyFilter(),this.createFilter()),n==="filterText"&&this.changePlaceHolder(),this.filter())},setOptions:function(n){for(var t in n)t in this.options&&(this.options[t]=n[t]);"sort"in n?(this.destroySort(),this.createSort(),this.triggerSort()):("sortKey"in n||"sortDir"in n)&&this.sort();"filters"in n&&(this.destroyFilter(),this.createFilter());"filterText"in n&&this.changePlaceHolder();this.filter()},destroy:function(){var n,t,i;for(this.refreshTimeOut!==undefined&&clearTimeout(this.refreshTimeOut),this.destroySort(),n=0;n<this.pagingDivs.length;++n)this.pagingDivs[n].classList.remove("pagination-datatable"),this.pagingDivs[n].classList.remove(this.options.pagingDivClass),this.pagingDivs[n].innerHTML="";for(this.destroyFilter(),this.table.classList.remove(this.options.tableClass),this.removeNode(this.table.tBodies[0]),this.table.appendChild(document.createElement("tbody")),n=0;n<this.data.length;n++)t=this.filterIndex[this.currentStart+n],i=this.data[t],this.table.tBodies[0].appendChild(this.options.lineFormat.call(this.table,t,i))}};DataTable.defaultOptions={forceStrings:!1,tableClass:"datatable",pagingDivSelector:".paging",pagingDivClass:"text-center",pagingListClass:"pagination",counterDivSelector:".counter",loadingDivSelector:".loading",sort:!1,sortKey:!1,sortDir:"asc",nbColumns:-1,pageSize:20,pagingNumberOfPages:9,identify:!1,onChange:function(){},counterText:function(n,t,i,r,u,f){var e="Page "+n+" on "+t+". Showing "+i+" to "+r+" of "+u+" entries";return u!=f&&(e+=" (filtered from "+f+" total entries)"),e+"."},firstPage:"&lt;&lt;",prevPage:"&lt;",pagingPages:!1,nextPage:"&gt;",lastPage:"&gt;&gt;",dataTypes:!0,filters:{},filterText:"Search... ",filterEmptySelect:"",filterSelectOptions:!1,filterInputClass:"form-control",filterSelectClass:"form-control",beforeRefresh:function(){},afterRefresh:function(){},lineFormat:function(n,t){var i=document.createElement("tr"),r;i.dataset.id=n;for(r in t)t.hasOwnProperty(r)&&(i.innerHTML+="<td>"+t[r]+"<\/td>");return i}};DataTable.defaultAjaxOptions={url:null,size:null,refresh:!1,allInOne:!1,timeout:2e3};